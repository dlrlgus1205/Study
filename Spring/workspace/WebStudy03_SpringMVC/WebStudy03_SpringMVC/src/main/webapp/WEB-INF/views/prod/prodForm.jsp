...
<form:form modelAttribute="${ProdInsertController.MODELNAME }" method="post" enctype="multipart/form-data">
	<table>
		<tr>
			<th>상품명</th>
			<td>
				<form:input type="text" path="prodName" 
					class="form-control" />
		...
		<tr>
			<th>구매가</th>
			<td>
				<form:input type="number" path="prodCost" 
					class="form-control" />
		...
		<tr>
			<th>판매가</th>
			<td>
				<form:input type="number" path="prodPrice" 
					class="form-control" />
		...
		<tr>
			<th>세일가</th>
			<td>
				<form:input type="number" path="prodSale" 
					class="form-control" />
		...
		<tr>
			<th>요약정보</th>
			<td>
				<form:input type="text" path="prodOutline" 
					class="form-control" />
