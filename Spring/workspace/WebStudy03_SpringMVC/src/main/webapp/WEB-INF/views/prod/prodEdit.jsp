...
<form method="post" enctype="application/x-www-form-urlencoded">
	<table class="table table-bordered">
		<tr style="display:none;">
			<td> <input type="hidden" name="prodId" value="${prod.prodId}" class="form-control" > </td>
		</tr>
		<tr>
			<th>상품명</th>
			<td><input type="text" name="prodName" value="${prod.prodName}"
				class="form-control"><span class="text-danger">${errors.prodName}
			</span></td>
		</tr>
		<tr>
			<th>상품분류</th>
		...
		<tr>
			<th>거래처</th>
			<td>
				<input type = "hidden" name="buyer" value="${prod.prodLgu }" />
				${prod.lprod.lprodNm }
			</td>
		</tr>
		<tr>
...
<script type="text/javascript" src="${pageContext.request.contextPath }/resources/js/app/prod/prodForm.js"></script>