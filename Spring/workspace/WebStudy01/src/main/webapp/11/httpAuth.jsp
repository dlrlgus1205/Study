...
1. 헤더 기반의 인증
	ex)
	보호자원(/09/mbti)에 대해 미인증된 사용자가 접근한 경우, 응답으로 401 상태코드와 www-authenticate:authType[BASIC:BAERER] 헤더를 전송함
	브라우저가 응답을 받고, 인증 정보를 입력받을 수 있는 UI 를 선택함
	인증된 후, 인증 상태 정보 유지에 (authorization:authType[BASIC:BAERER] base64 인코딩 된 사용자 정보) 헤더를 사용함
