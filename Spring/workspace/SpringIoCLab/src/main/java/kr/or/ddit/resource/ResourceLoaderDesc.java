 ...
 * 2. ClassPathResource : 클래스패스 이후의 qualified name(논리 경로) 을 통해 접근
 * 3. UrlResource : 웹 상에 존재하는 url(논리 경로) 로 접근하는 자원
 * 
 * ResourceLoader : 자원의 분류와 관계없이 일관된 방법으로 Resource 를 로딩해주는 객체
 *
 */
@Slf4j
