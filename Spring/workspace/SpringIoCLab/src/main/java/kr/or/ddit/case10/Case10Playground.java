...
public class Case10Playground {
	public static void main(String[] args) {
		ConfigurableApplicationContext root = new AnnotationConfigApplicationContext(RootContext.class);
		ConfigurableApplicationContext child = new ClassPathXmlApplicationContext(new String[] {"kr/or/ddit/case10/conf/child-context.xml"}, root);
