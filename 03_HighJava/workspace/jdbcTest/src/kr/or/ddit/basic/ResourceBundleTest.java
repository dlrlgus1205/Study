...
/*
	ResourceBundle 객체 ==> 파일의 확장자가 'properties'인 파일의 내용을 읽어와 key 값과 value 값을 분리해서 정보를 갖고 있는 객체
*/
public class ResourceBundleTest {
	public static void main(String[] args) {
		...
		// ==> 읽어올 파일을 지정할 때 '패키지명.파일명"까지만 지정하고 확장자는 지정하지 않는다. (이유 : 확장자는 항상 'properties'이기 때문)
