...
public class SetTest {
	public static void main(String[] args) {
		...
		그래서 데이터를 하나씩 얻기 위해서는 Iterator 형의 객체로 변환해야한다.
		...
		// Iterator 의 next() 메서드
		//		==> Iterator의 포인터를 다음번째 위치로 이동한 후 위치에 있는 데이터를 읽어서 반환한다.
		...
		// (int)(Math.random()*(종료값 - 시작값 +1) + 시작값) -공식
