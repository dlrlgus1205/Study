 ...
 * 
 * - Comparable은 Collection에 추가되는 데이터 자체에 정렬 기준을 넣고 싶을 때 구현하는 인터페이스이다. (내부 정렬 기준이라고 한다.)
 ...
 *   
 *   - String 클래스, Wrapper 클래스, Date 클래스, File 클래스에는 내부 정렬 기준이 이미 구현돼있다. (내부 정렬 기준은 오름차순으로 처리되도록 구현돼있다.)
 */
public class ListSortTest01 {
	public static void main(String[] args) {
		...
		// 정렬 작업은 Collections.sort() 메서드를 이용하여 정렬한다.
		...
		Collections.shuffle(list); // list 안의 데이터 섞기
		System.out.println("자료 섞기 후 : " + list);
		
		// 외부 정렬 기준을 적용해서 정렬하기
		// 형식) Collections.sort(리스트, 외부 정렬 기준 객체)
