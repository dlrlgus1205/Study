...
//		      data : JSON.stringify(queryString),
		      ...
		      success : function(json){
		    	  ...
		    	  if(json==null){
		        	 ...
		        	 result="회원님의 아이디는"+json.mem_id+"입니다.";
		         }
		    	 $('#resultdiv').empty();
      ...
      <div class="contents-inner">
        <div class="contents-container">
          <div class="textset textset-h2">
            ...
            <p class="p2" id="p2"><br>이름과 이메일 주소를 입력해주세요. </p>
          </div>
            ...
            <div class="contents-form-bottom">
              <div class="inputset inputset-lg inputset-label">
                <label>
                  ...
                  <input type="text" class="inputset-input form-control" placeholder="이름을 입력해 주세요." required="true" name="mem_name">
                </label>
              </div>                
              <div class="inputset inputset-lg inputset-label">
                <label>
          ...
          <button type="button" id ="btn1" class="btnset btnset-lg contents-submit">아이디 찾기</button>
        </div>
      </div>
    </div>
   </form>
