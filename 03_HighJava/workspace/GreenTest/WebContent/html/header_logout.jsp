    ...
    <div class="header-container container-lg">
      ...
      <div class="header-right">
        <div class="header-utils">
          ...
          <a href="<%=request.getContextPath() %>/html/login.jsp" class="btn-login header-utils-btn" title="login"></a>
<!--           <a href="javascript:void(0);" class="btn-logout header-utils-btn" title="logout"></a> -->
